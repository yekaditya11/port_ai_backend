...
with engine.begin() as conn:
    conn.execute(text("DROP TABLE IF EXISTS investigation_teams, sequence_of_events, peepos, investigation_analyses, involved_persons, witnesses, equipment_involved, container_details, environmental_details, task_conditions, permit_details, actions, root_cause_analyses, workflow_events, incidents, enum_values, users, departments, sub_areas, operational_activities, equipment, shipping_lines CASCADE;"))
